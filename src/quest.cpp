...
SPECIAL(johnson)
{
    ...
    if (CMD_IS("say") || CMD_IS("'")) {
        if (strstr(argument, "quit"))
            comm = CMD_QUIT;
        else if (strstr(argument, "collect") || strstr(argument, "complete"))
            comm = CMD_DONE;
        else if (strstr(argument, "work") || strstr(argument, "business") ||
                 strstr(argument, "run") || strstr(argument, "shadowrun") ||
                 strstr(argument, "job") || strstr(argument, "Work") ||
                 strstr(argument, "Business") || strstr(argument, "Run") ||
                 strstr(argument, "Shadowrun") || strstr(argument, "Job") )
            comm = CMD_START;
        else if (strstr(argument, "yes") || strstr(argument, "accept") ||
                 strstr(argument, "Yes") || strstr(argument, "Accept") )
            comm = CMD_YES;
        else if (strstr(argument, "no") || strstr(argument, "No") )
            comm = CMD_NO;
