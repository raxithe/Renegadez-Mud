...
struct command_info cmd_info[] =
{
    ...
    { "auth"     , POS_DEAD    , do_auth     , LVL_FIXER, 0 },
    ...
    { "ident"    , POS_DEAD    , do_ident    , LVL_DEVELOPER, 0 },
    ...
    { "packup"   , POS_STANDING, do_packup   , 0, 0 },
    ...
    { "pretitle" , POS_DEAD    , do_wiztitle , LVL_BUILDER, SCMD_PRETITLE },
    ...
    { "restring" , POS_DEAD    , do_restring , LVL_CONSPIRATOR, 0 },
    ...
    { "sdelete"  , POS_DEAD    , do_sdelete  , LVL_BUILDER, 0 },
    ...
    { "steal"    , POS_STANDING, do_steal    , LVL_DEVELOPER, 0 },
    ...
    { "unpack"   , POS_STANDING, do_unpack   , 0, 0 },
...
void nanny(struct descriptor_data * d, char *arg)
{
    ...
    case CON_MENU:                /* get selection from main menu  */
        ...
        case '1':
            ...
            if(PLR_FLAGGED(d->character,PLR_AUTH)) {
                send_to_char(AUTH_MESSG,d->character);
            }
            ...
            if ((GET_RACE(d->character) == RACE_DWARF) ||
                ...
                d->character->char_specials.saved.affected_by.SetBit(AFF_INFRAVISION);
            else if (GET_RACE(d->character) != RACE_HUMAN)
                d->character->char_specials.saved.affected_by.SetBit(AFF_LOW_LIGHT);
